...
This is an implementation of a CasperLabs vesting smart contract separated into the smart contract layer that uses the contract logic, and a smart contract test.
