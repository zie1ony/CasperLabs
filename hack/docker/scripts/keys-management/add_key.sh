...
NEW_KEY_HEX=$(cat "${NEW_KEY}/${ACCOUNT_ID_HEX_FILE}")
WASM_FILE="${BASE_PATH}/execution-engine/target/wasm32-unknown-unknown/release/add_update_associated_key.wasm"
